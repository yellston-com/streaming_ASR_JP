...
Includes model loading, configuration adjustments, and real-time transcription via PyAudio.
"""
...
# Load and restore the pretrained QuartzNet model for Japanese ASR
# asr_model = nemo_asr.models.EncDecCTCModel.from_pretrained('QuartzNet15x5Base-En')
asr_model = nemo_asr.models.EncDecCTCModel.restore_from(restore_path='./quartznet_jp/japanese-quartznet-large.nemo')


# ASR model and dataset imports
from omegaconf import OmegaConf
import copy


# Preserve original model config for later reference
...
# Define fixed mean and std for spectrogram normalization
...
# Initialize PyAudio and list available input devices
p = pa.PyAudio()
...
if len(input_devices):
    ...
    # Callback function: processes each incoming audio buffer and prints decoded text
